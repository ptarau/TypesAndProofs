%--------------------------------------------------------------------------
% File     : SYJ209+1.007 : ILTP v1.1.2
% Domain   : Intuitionistic Syntactic
% Problem  : Formulae requiring many contractions
% Version  : Especial.
%            Problem formulation : Inuit. Invalid.   Size 7
...
%                    R-89/89006, 1989.
% Source   : [Dyc97]
% Names    : con_n7 : Dyckhoff's benchmark formulas (1997)
%
...
%--------------------------------------------------------------------------
fof(axiom1,axiom,(
( ( ( p1 & ( p2 & ( p3 & ( p4 & ( p5 & ( p6 & p7 ) ) ) ) ) ) v ( ( ~(~(p1)) -> f)  v ( ( p2 -> f)  v ( ( p3 -> f)  v ( ( p4 -> f)  v ( ( p5 -> f)  v ( ( p6 -> f)  v ( p7 -> f)  ) ) ) ) ) ) ) -> f) )).
