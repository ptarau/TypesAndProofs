%--------------------------------------------------------------------------
% File     : SYJ209+1.017 : ILTP v1.1.2
% Domain   : Intuitionistic Syntactic
% Problem  : Formulae requiring many contractions
% Version  : Especial.
%            Problem formulation : Inuit. Invalid.   Size 17
...
%                    R-89/89006, 1989.
% Source   : [Dyc97]
% Names    : con_n17 : Dyckhoff's benchmark formulas (1997)
%
...
%--------------------------------------------------------------------------
fof(axiom1,axiom,(
( ( ( p1 & ( p2 & ( p3 & ( p4 & ( p5 & ( p6 & ( p7 & ( p8 & ( p9 & ( p10 & ( p11 & ( p12 & ( p13 & ( p14 & ( p15 & ( p16 & p17 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) v ( ( ~(~(p1)) -> f)  v ( ( p2 -> f)  v ( ( p3 -> f)  v ( ( p4 -> f)  v ( ( p5 -> f)  v ( ( p6 -> f)  v ( ( p7 -> f)  v ( ( p8 -> f)  v ( ( p9 -> f)  v ( ( p10 -> f)  v ( ( p11 -> f)  v ( ( p12 -> f)  v ( ( p13 -> f)  v ( ( p14 -> f)  v ( ( p15 -> f)  v ( ( p16 -> f)  v ( p17 -> f)  ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) -> f) )).
